...
ThisBuild / organization     := "dev.langnet"
ThisBuild / organizationName := "langnet"
...
publishTo := {
  val nexus = "https://thoth.langnet.dev/"
  if (isSnapshot.value)
...
credentials += Credentials(
  "Sonatype Nexus Repository Manager", "thoth.langnet.dev", "admin", "64bb77c1-ef0c-4f3f-a1a9-edabe131a51b"
)
